...
function main() {
    ...
    animate_start = () => {
        ...
        tanceng0.y = (canvas.height - 600 * proportion * 0.5) / 2 - 100 * proportion + 600 * proportion * 0.5 / 2;
        tanceng0.alpha = 0;
        ...
        paoliao2.x = (canvas.width - 185 * proportion * 0.5) / 2 + 120 * proportion;
        paoliao2.y = (canvas.height - 70 * proportion * 0.5) / 2 - 170 * proportion;
        paoliao2.alpha = 0;
        ...
        faxiaoText2.scaleX = 0;
        faxiaoText2.scaleY = 0;
        faxiaoText2.x = canvas.width / 2;
        ...
        tanceng1.y = (canvas.height - 600 * proportion * 0.5) / 2 - 300 * proportion + 600 * proportion * 0.5 / 2;
        tanceng1.alpha = 0;
            ...
            createjs.Tween.get(wannianzao, { loop: true })
                .call(() => {
                    ...
                    createjs.Tween.get(paoliao1)
                        .wait(3000)
                        .to({
                            x: (canvas.width - 185 * proportion * 0.5) / 2 - 120 * proportion,
                            y: (canvas.height - 70 * proportion * 0.5) / 2 - 170 * proportion,
                            alpha: 1
                        }, 2000, sineInOutEase)
                        .wait(500)
                        .to({
                                ...
                                .call(() => {
                                    ...
                                    createjs.Tween.get(tanceng0)
                                        ...
                                        .to({
                                            ...
                                            scaleY: proportion * 0.5,
                                            x: (canvas.width - 500 * proportion * 0.5) / 2,
                                            y: (canvas.height - 600 * proportion * 0.5) / 2 - 100 * proportion,
                                            alpha: 1
                                        }, 2000)
                                        .call(() => {
                        ...
                        .call(() => {
                            ...
                            createjs.Tween.get(faxiaoText2)
                                ...
                                .to({
                                    scaleX: proportion * 0.5,
                                    scaleY: proportion * 0.5,
                                    x: (canvas.width - 563 * proportion * 0.5) / 2,
                                    alpha: 1
                                }, 1000)
                            createjs.Tween.get(faxiaoText5)
                                .wait(1500)
